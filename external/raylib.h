...
#define BACKWHITE   CLITERAL(Color){ 233, 233, 225, 255 }   // My own
#define ITEMGRAY   CLITERAL(Color){ 255-66, 255 - 66, 255 -55, 255 }   // My own
#define TEXTBLACK   CLITERAL(Color){ 95, 65, 65, 255 }   // My own
